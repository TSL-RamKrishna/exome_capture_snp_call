...
for sample in sample_set:
    ...
    varscan_cmd="rake -f rakefile projectdir=/usr/users/TSL_20/shrestha/workarea/yogesh/exome_capure  sampleid=" + sample + " reference= " + reference + " varscan:run"
    os.system('echo sbatch --mem 10G -o ' + sample + '.rakelog ' + ' -J ' + sample + ' --wrap ' + '\"' + cmd1 + "; " + cmd2 + "; " + varscan_cmd + '\"')
